...
lab5_path = os.path.abspath(os.path.join(os.getcwd(), '..', 'session5', 'lab'))

if lab5_path not in sys.path:
    sys.path.append(lab5_path)

import Lab_5 as program_1
...
NB_GAMES = 100 # 1000 # 5 if you want to test the script, 1000 if you want to run the challenge in real conditions.
